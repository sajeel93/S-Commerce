const BlogCard = () => {
    return (
        <>
            <div className="grid">
                <div class=" bg-Neutral-primary bg-opacity-5 flex flex-wrap items-center justify-center">
                    <div class=" bg-Neutral-white rounded shadow-lg transform duration-200 easy-in-out">
                        ...
                        <div class="flex justify-start px-5 -mt-12 mb-5">
                            <span clspanss="block relative h-32 w-32">
                                <img
                                    ...
                                    class="mx-auto object-cover rounded-full h-24 w-24 bg-Neutral-white p-1"
                                />
                            </span>
                        </div>
                        <div class="">
                            <div class="px-7 mb-8">
                                <h2 class="text-3xl font-bold text-Neutral-primary">
                                    Beth J. Greene
                                </h2>
                                <p class="text-Neutral-primary mt-2">
                                    Illustrator
                                </p>
                                <p class="mt-2 text-Neutral-black">
                                    Lorem ipsum dolor sit amet consectetur,
                                    adipisicing elit. Asperiores molestiae vitae
                                    odio non commodi itaque quisquam incidunt
                                    doloribus fugit nesciunt.
                                </p>
                                <div class="justify-center px-4 py-2 cursor-pointer bg-Neutral-primary max-w-min mx-auto mt-8 rounded-lg text-Neutral-white hover:bg-Neutral-secondary">
                                    sajeel.ahmed786@gmail.com
                                </div>
                                <div class="flex flex-wrap justify-center gap-2 sm:gap-4 mt-8">
                                    <button class="text-Neutral-black hover:text-Neutral-primary p-1 sm:p-2 inline-flex items-center">
                                        <svg
